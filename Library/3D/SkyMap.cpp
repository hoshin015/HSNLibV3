...
SkyMap::SkyMap(const wchar_t* filename)
{
    ...
    sprSky = std::make_unique<Sprite>("Data/Texture/skymap/country_club_4k/specular_pmrem.dds", "./Data/Shader/SkyMap_PS.cso", "./Data/Shader/SkyMap_VS.cso", false);
    sprSky->SetSize({ 1280,720 });


    //--- < 画像ファイルのロードとshaderResourceViewの生成とテクスチャ情報の取得 > ---
    D3D11_TEXTURE2D_DESC texture2dDesc;
    LoadTextureFromFile(L"Data/Texture/skymap/country_club_4k/diffuse_iem.dds", diffuseIemSrv.GetAddressOf(), &texture2dDesc);
