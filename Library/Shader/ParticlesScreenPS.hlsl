...
Texture2D screenParticleTexture : register(_screenParticleTexture);
...
{
    float4 textureColor = screenParticleTexture.Sample(samplerStates[_pointSampler], pin.texcoord);
